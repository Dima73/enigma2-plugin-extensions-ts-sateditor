...
class TransponderEditor(Screen, ConfigListScreen, Transponder):
	...
	def createConfig(self):
		...
		self.configTransponderT2miPlpId = ConfigInteger(default=int(self.t2mi_plp_id), limits=(0, 255))
		self.configTransponderT2miPid = ConfigInteger(default=int(self.t2mi_pid), limits=(0, 8191))
